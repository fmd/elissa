...
function themeit_tiny_mce_before_init( $settings )
{
	...
	$style_formats = array(
		array( 'title' => '1/2 Col.',      	'block'    => 'div',  'classes' => 'one-half' ),
		array( 'title' => '1/4 Col.',      	'block'    => 'div',  'classes' => 'one-quarter' ),
		array( 'title' => 'Highlight',          'inline'   => 'span', 'classes' => 'highlight' ),
		array( 'title' => 'Quote Aside',        'block'    => 'div',  'classes' => 'quote-aside' ),
		
		array( 'title' => 'Buttons' ),
		array( 'title' => 'Blue Medium',		'inline' => 'span',  'classes' => 'medium blue awesome' ),
		array( 'title' => 'Blue Small',			'inline' => 'span',  'classes' => 'small blue awesome' ),
		array( 'title' => 'Blue Tiny',			'inline' => 'span',  'classes' => 'tiny blue awesome' ),
      
		array( 'title' => 'Green Medium',		'inline' => 'span',  'classes' => 'medium green awesome' ),
		array( 'title' => 'Green Small',		'inline' => 'span',  'classes' => 'small green awesome' ),
		array( 'title' => 'Green Tiny',			'inline' => 'span',  'classes' => 'tiny green awesome' ),
      
		array( 'title' => 'Dark Medium',		'inline' => 'span',  'classes' => 'medium black awesome' ),
		array( 'title' => 'Dark Small',			'inline' => 'span',  'classes' => 'small black awesome' ),
		array( 'title' => 'Dark Tiny',			'inline' => 'span',  'classes' => 'tiny black awesome' ),
      
		array( 'title' => 'Gray Medium',		'inline' => 'span',  'classes' => 'medium gray awesome' ),
		array( 'title' => 'Gray Small',			'inline' => 'span',  'classes' => 'small gray awesome' ),
		array( 'title' => 'Gray Tiny',			'inline' => 'span',  'classes' => 'tiny gray awesome' )
	);
