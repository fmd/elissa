				...
				<form action="/" method="get" accept-charset="utf-8">
					...
					<div>
						...
						<select name="column-width" id="column-width" size="1">
							<option value="shortcode-third-column" selected="selected">1/3 Column</option>
							<option value="shortcode-half-column"=>1/2 Column</option>
							<option value="shortcode-quarter-column">1/4 Column</option>
						</select>
					</div>
				...
				<form action="/" method="get" accept-charset="utf-8">
					...
					<div>
						...
						<select name="message-type" id="message-type" size="1">
							...
							<option value="orange-message">Info Message</option>
							<option value="note-message">Text Message</option>
						</select>
					</div>
